CollisionChecking MATLAB Python Package
...
2. Installing the CollisionChecking Package

A. Change to the directory that contains the file setup.py and the subdirectory 
CollisionChecking. If you do not have write permissions, copy all its contents to a 
...
3. Using the CollisionChecking Package

The CollisionChecking package is on your Python path. To import it into a Python script 
or session, execute:
